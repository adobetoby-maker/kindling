...
28, 29, 30, using **Calder**.

Read `/Users/drive/penname/pennamecodexv3/workflows/book-narrator-1.2.5.md` first, then read `/Users/drive/git-backups/kindling/books/book-01-kindled/narration/monroe-1.2.5/calder/chapters-28-30/RUN.md` and every selected
